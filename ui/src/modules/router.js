...
class PageRouter {
  ...
  async registerRoutes() {
    try {
      ...
      // Register route aliases (before the catch-all 404)
      ...
      // Fallback to hana-rag route
      router("/", () => this.loadPage("hana-rag"));
    }
  }
  ...
  async show404() {
    ...
    this.contentContainer.innerHTML = `
      <div style="padding: 2rem; text-align: center;">
        ...
        <ui5-button style="margin-top: 1rem;" onclick="pageRouter.navigate('/hana-rag')">
          Ir a Consulta Procedimientos
        </ui5-button>
      </div>
    `;
